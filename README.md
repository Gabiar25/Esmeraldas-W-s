...
- **Número de WhatsApp**: actualmente es `573208130979` (busca ese número en `backend/public/*.html` y `checkout.js` si necesitas cambiarlo de nuevo; con indicativo, sin `+` ni espacios).
